...
func (this *Blofin) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("blofin"),
		"name": MkString("blofin"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.blofin.com"),
				"private": MkString("https://api.blofin.com"),
			}),
			"www": MkString("https://www.blofin.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Blofin) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Blofin) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Blofin) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Blofin) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Blofin) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
