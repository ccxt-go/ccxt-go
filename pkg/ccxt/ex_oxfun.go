...
func (this *Oxfun) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.oxfun.com"),
				"private": MkString("https://api.oxfun.com"),
			}),
			"www": MkString("https://www.oxfun.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Oxfun) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Oxfun) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Oxfun) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Oxfun) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Oxfun) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
