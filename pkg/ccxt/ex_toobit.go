...
func (this *Toobit) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("toobit"),
		"name": MkString("toobit"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.toobit.com"),
				"private": MkString("https://api.toobit.com"),
			}),
			"www": MkString("https://www.toobit.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Toobit) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Toobit) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Toobit) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Toobit) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Toobit) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
