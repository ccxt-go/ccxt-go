...
func (this *Fmfwio) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("fmfwio"),
		"name": MkString("fmfwio"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.fmfwio.com"),
				"private": MkString("https://api.fmfwio.com"),
			}),
			"www": MkString("https://www.fmfwio.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Fmfwio) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Fmfwio) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Fmfwio) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Fmfwio) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Fmfwio) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
