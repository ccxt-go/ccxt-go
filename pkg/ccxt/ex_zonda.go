...
func (this *Zonda) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.zonda.com"),
				"private": MkString("https://api.zonda.com"),
			}),
			"www": MkString("https://www.zonda.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Zonda) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Zonda) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Zonda) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Zonda) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Zonda) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
