...
func (this *Tokocrypto) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("tokocrypto"),
		"name": MkString("tokocrypto"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.tokocrypto.com"),
				"private": MkString("https://api.tokocrypto.com"),
			}),
			"www": MkString("https://www.tokocrypto.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Tokocrypto) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Tokocrypto) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Tokocrypto) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Tokocrypto) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Tokocrypto) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
