...
func (this *P2b) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.p2b.com"),
				"private": MkString("https://api.p2b.com"),
			}),
			"www": MkString("https://www.p2b.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *P2b) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *P2b) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *P2b) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *P2b) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *P2b) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
