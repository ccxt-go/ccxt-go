...
func (this *Therock) FetchMarkets(goArgs ...*Variant) *Variant {
	...
	_ = params
	response := this.Call(MkString("publicGetFunds"), params)
	_ = response
	markets := this.SafeValue(response, MkString("funds"))
	_ = markets
	...
	if IsTrue(OpEq2(markets, MkUndefined())) {
		...
		for i := MkInteger(0); IsTrue(OpLw(i, markets.Length)); OpIncr(&i) {
			...
			_ = id
			baseId := this.SafeString(market, MkString("trade_currency"))
			_ = baseId
			quoteId := this.SafeString(market, MkString("base_currency"))
			_ = quoteId
			...
			_ = symbol
			buy_fee := this.SafeNumber(market, MkString("buy_fee"))
			_ = buy_fee
			sell_fee := this.SafeNumber(market, MkString("sell_fee"))
			_ = sell_fee
			taker := Math.Max(buy_fee, sell_fee)
			_ = taker
...
func (this *Therock) FetchBalance(goArgs ...*Variant) *Variant {
	...
	_ = response
	balances := this.SafeValue(response, MkString("balances"), MkArray(&VarArray{}))
	_ = balances
...
func (this *Therock) FetchOrderBook(goArgs ...*Variant) *Variant {
	...
	_ = request
	orderbook := this.Call(MkString("publicGetFundsIdOrderbook"), this.Extend(request, params))
	_ = orderbook
	timestamp := this.Parse8601(this.SafeString(orderbook, MkString("date")))
	_ = timestamp
...
func (this *Therock) ParseTicker(goArgs ...*Variant) *Variant {
	...
	_ = market
	timestamp := this.Parse8601(*(ticker).At(MkString("date")))
	_ = timestamp
...
func (this *Therock) FetchTickers(goArgs ...*Variant) *Variant {
	...
	_ = params
	this.LoadMarkets()
	response := this.Call(MkString("publicGetFundsTickers"), params)
	_ = response
	tickers := this.IndexBy(*(response).At(MkString("tickers")), MkString("fund_id"))
	_ = tickers
...
func (this *Therock) FetchTicker(goArgs ...*Variant) *Variant {
	...
	_ = market
	ticker := this.Call(MkString("publicGetFundsIdTicker"), this.Extend(MkMap(&VarMap{"id": *(market).At(MkString("id"))}), params))
	_ = ticker
...
func (this *Therock) ParseTrade(goArgs ...*Variant) *Variant {
	...
	market := GoGetArg(goArgs, 1, MkUndefined())
	_ = market
	marketId := this.SafeString(trade, MkString("fund_id"))
	_ = marketId
	...
	_ = feeCost
	transactions := this.SafeValue(trade, MkString("transactions"), MkArray(&VarArray{}))
	_ = transactions
	transactionsByType := this.GroupBy(transactions, MkString("type"))
	_ = transactionsByType
	feeTransactions := this.SafeValue(transactionsByType, MkString("paid_commission"), MkArray(&VarArray{}))
	_ = feeTransactions
...
func (this *Therock) ParseLedgerEntryDirection(goArgs ...*Variant) *Variant {
	direction := GoGetArg(goArgs, 0, MkUndefined())
	_ = direction
...
func (this *Therock) ParseLedgerEntry(goArgs ...*Variant) *Variant {
	...
	_ = referenceId
	type_ := this.SafeString(item, MkString("type"))
	_ = type_
	direction := this.ParseLedgerEntryDirection(type_)
	_ = direction
	...
	code := this.SafeCurrencyCode(currencyId)
	_ = code
	amount := this.SafeNumber(item, MkString("price"))
	_ = amount
	timestamp := this.Parse8601(this.SafeString(item, MkString("date")))
	_ = timestamp
	status := MkString("ok")
	_ = status
	return MkMap(&VarMap{
...
func (this *Therock) FetchLedger(goArgs ...*Variant) *Variant {
	...
	_ = response
	transactions := this.SafeValue(response, MkString("transactions"), MkArray(&VarArray{}))
	_ = transactions
...
func (this *Therock) ParseTransaction(goArgs ...*Variant) *Variant {
	...
	_ = id
	type_ := this.ParseTransactionType(this.SafeString(transaction, MkString("type")))
	_ = type_
	detail := this.SafeValue(transaction, MkString("transfer_detail"), MkMap(&VarMap{}))
	_ = detail
	method := this.SafeString(detail, MkString("method"))
	_ = method
	...
	code := this.SafeCurrencyCode(currencyId)
	_ = code
	amount := this.SafeNumber(transaction, MkString("price"))
	_ = amount
...
func (this *Therock) FetchDeposits(goArgs ...*Variant) *Variant {
	...
	params := GoGetArg(goArgs, 3, MkMap(&VarMap{}))
	_ = params
	request := MkMap(&VarMap{"type": MkString("atm_payment")})
	_ = request
	return this.FetchTransactions(code, since, limit, this.Extend(request, params))
}
...
func (this *Therock) FetchTransactions(goArgs ...*Variant) *Variant {
	...
	response := this.Call(MkString("privateGetTransactions"), params)
	_ = response
	transactions := this.SafeValue(response, MkString("transactions"), MkArray(&VarArray{}))
	_ = transactions
	...
	_ = transactionTypes
	depositsAndWithdrawals := this.FilterByArray(transactions, MkString("type"), transactionTypes, MkBool(false))
	_ = depositsAndWithdrawals
...
func (this *Therock) ParseOrder(goArgs ...*Variant) *Variant {
	...
	_ = id
	marketId := this.SafeString(order, MkString("fund_id"))
	_ = marketId
	symbol := this.SafeSymbol(marketId, market)
	_ = symbol
	...
	_ = amount
	remaining := this.SafeNumber(order, MkString("amount_unfilled"))
	_ = remaining
	...
	stopPrice := this.SafeNumber(order, MkString("conditional_price"))
	_ = stopPrice
	return MkMap(&VarMap{
		"id":                 id,
...
func (this *Therock) FetchOpenOrders(goArgs ...*Variant) *Variant {
	...
	params := GoGetArg(goArgs, 3, MkMap(&VarMap{}))
	_ = params
	request := MkMap(&VarMap{"status": MkString("active")})
	_ = request
...
func (this *Therock) FetchClosedOrders(goArgs ...*Variant) *Variant {
	...
	params := GoGetArg(goArgs, 3, MkMap(&VarMap{}))
	_ = params
	request := MkMap(&VarMap{"status": MkString("executed")})
	_ = request
	return this.FetchOrders(symbol, since, limit, this.Extend(request, params))
}
...
func (this *Therock) FetchOrders(goArgs ...*Variant) *Variant {
	...
	market := this.Market(symbol)
	_ = market
	request := MkMap(&VarMap{"fund_id": *(market).At(MkString("id"))})
	_ = request
	if IsTrue(OpNotEq2(since, MkUndefined())) {
		*(request).At(MkString("after")) = this.Iso8601(since)
	}
	response := this.Call(MkString("privateGetFundsFundIdOrders"), this.Extend(request, params))
	_ = response
...
func (this *Therock) FetchOrder(goArgs ...*Variant) *Variant {
	...
	_ = request
	response := this.Call(MkString("privatePostFundsFundIdOrdersId"), this.Extend(request, params))
	_ = response
...
func (this *Therock) CreateOrder(goArgs ...*Variant) *Variant {
	...
	_ = request
	response := this.Call(MkString("privatePostFundsFundIdOrders"), this.Extend(request, params))
	_ = response
	return this.ParseOrder(response)
}
...
func (this *Therock) CancelOrder(goArgs ...*Variant) *Variant {
	...
	_ = request
	response := this.Call(MkString("privateDeleteFundsFundIdOrdersId"), this.Extend(request, params))
	_ = response
	return this.ParseOrder(response)
}
...
func (this *Therock) FetchMyTrades(goArgs ...*Variant) *Variant {
	...
	response := this.Call(MkString("privateGetFundsIdTrades"), this.Extend(request, params))
	_ = response
...
func (this *Therock) FetchTrades(goArgs ...*Variant) *Variant {
	...
	response := this.Call(MkString("publicGetFundsIdTrades"), this.Extend(request, params))
	_ = response
	return this.ParseTrades(*(response).At(MkString("trades")), market, since, limit)
}
...
func (this *Therock) HandleErrors(goArgs ...*Variant) *Variant {
	...
	errors := this.SafeValue(response, MkString("errors"), MkArray(&VarArray{}))
	_ = errors
	numErrors := OpCopy(errors.Length)
	_ = numErrors
