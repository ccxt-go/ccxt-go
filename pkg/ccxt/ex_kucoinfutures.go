...
var _ Exchange = (*Kucoinfutures)(nil)
...
func (this *Kucoinfutures) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("kucoinfutures"),
		"name": MkString("kucoinfutures"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.kucoinfutures.com"),
				"private": MkString("https://api.kucoinfutures.com"),
			}),
			"www": MkString("https://www.kucoinfutures.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Kucoinfutures) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Kucoinfutures) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Kucoinfutures) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Kucoinfutures) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Kucoinfutures) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
