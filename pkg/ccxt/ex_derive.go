...
func (this *Derive) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("derive"),
		"name": MkString("derive"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.derive.com"),
				"private": MkString("https://api.derive.com"),
			}),
			"www": MkString("https://www.derive.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Derive) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Derive) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Derive) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Derive) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Derive) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
