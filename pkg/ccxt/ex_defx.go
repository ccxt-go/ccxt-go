...
func (this *Defx) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.defx.com"),
				"private": MkString("https://api.defx.com"),
			}),
			"www": MkString("https://www.defx.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Defx) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Defx) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Defx) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Defx) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Defx) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
