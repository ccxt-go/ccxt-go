...
func (this *Apex) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.apex.com"),
				"private": MkString("https://api.apex.com"),
			}),
			"www": MkString("https://www.apex.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Apex) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Apex) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Apex) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Apex) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Apex) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
