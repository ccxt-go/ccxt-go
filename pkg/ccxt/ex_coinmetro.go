...
func (this *Coinmetro) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("coinmetro"),
		"name": MkString("coinmetro"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.coinmetro.com"),
				"private": MkString("https://api.coinmetro.com"),
			}),
			"www": MkString("https://www.coinmetro.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Coinmetro) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Coinmetro) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Coinmetro) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Coinmetro) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Coinmetro) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
