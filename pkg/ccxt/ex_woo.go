...
func (this *Woo) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.woo.com"),
				"private": MkString("https://api.woo.com"),
			}),
			"www": MkString("https://www.woo.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Woo) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Woo) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Woo) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Woo) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Woo) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
