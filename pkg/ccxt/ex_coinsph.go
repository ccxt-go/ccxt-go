...
func (this *Coinsph) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("coinsph"),
		"name": MkString("coinsph"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.coinsph.com"),
				"private": MkString("https://api.coinsph.com"),
			}),
			"www": MkString("https://www.coinsph.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Coinsph) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Coinsph) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Coinsph) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Coinsph) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Coinsph) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
