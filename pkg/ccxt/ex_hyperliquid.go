...
var _ Exchange = (*Hyperliquid)(nil)
...
func (this *Hyperliquid) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("hyperliquid"),
		"name": MkString("hyperliquid"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.hyperliquid.com"),
				"private": MkString("https://api.hyperliquid.com"),
			}),
			"www": MkString("https://www.hyperliquid.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Hyperliquid) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Hyperliquid) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Hyperliquid) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Hyperliquid) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Hyperliquid) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
