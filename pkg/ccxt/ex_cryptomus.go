...
func (this *Cryptomus) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("cryptomus"),
		"name": MkString("cryptomus"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.cryptomus.com"),
				"private": MkString("https://api.cryptomus.com"),
			}),
			"www": MkString("https://www.cryptomus.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Cryptomus) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Cryptomus) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Cryptomus) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Cryptomus) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Cryptomus) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
