...
func (this *Onetrading) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("onetrading"),
		"name": MkString("onetrading"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.onetrading.com"),
				"private": MkString("https://api.onetrading.com"),
			}),
			"www": MkString("https://www.onetrading.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Onetrading) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Onetrading) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Onetrading) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Onetrading) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Onetrading) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
