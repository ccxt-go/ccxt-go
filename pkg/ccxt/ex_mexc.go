...
func (this *Mexc) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.mexc.com"),
				"private": MkString("https://api.mexc.com"),
			}),
			"www": MkString("https://www.mexc.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Mexc) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Mexc) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Mexc) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Mexc) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Mexc) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
