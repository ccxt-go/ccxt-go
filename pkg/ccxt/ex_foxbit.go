...
func (this *Foxbit) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("foxbit"),
		"name": MkString("foxbit"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.foxbit.com"),
				"private": MkString("https://api.foxbit.com"),
			}),
			"www": MkString("https://www.foxbit.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Foxbit) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Foxbit) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Foxbit) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Foxbit) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Foxbit) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
