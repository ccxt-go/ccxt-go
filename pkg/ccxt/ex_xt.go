...
func (this *Xt) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.xt.com"),
				"private": MkString("https://api.xt.com"),
			}),
			"www": MkString("https://www.xt.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Xt) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Xt) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Xt) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Xt) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Xt) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
