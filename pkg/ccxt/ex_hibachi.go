...
func (this *Hibachi) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("hibachi"),
		"name": MkString("hibachi"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.hibachi.com"),
				"private": MkString("https://api.hibachi.com"),
			}),
			"www": MkString("https://www.hibachi.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Hibachi) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Hibachi) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Hibachi) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Hibachi) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Hibachi) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
