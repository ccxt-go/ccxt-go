...
func (this *Arkham) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("arkham"),
		"name": MkString("arkham"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.arkham.com"),
				"private": MkString("https://api.arkham.com"),
			}),
			"www": MkString("https://www.arkham.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Arkham) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Arkham) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Arkham) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Arkham) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Arkham) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
