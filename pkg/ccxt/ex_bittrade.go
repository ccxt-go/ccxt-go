...
func (this *Bittrade) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("bittrade"),
		"name": MkString("bittrade"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.bittrade.com"),
				"private": MkString("https://api.bittrade.com"),
			}),
			"www": MkString("https://www.bittrade.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Bittrade) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Bittrade) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Bittrade) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Bittrade) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Bittrade) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
