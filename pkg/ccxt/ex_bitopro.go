...
func (this *Bitopro) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("bitopro"),
		"name": MkString("bitopro"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.bitopro.com"),
				"private": MkString("https://api.bitopro.com"),
			}),
			"www": MkString("https://www.bitopro.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Bitopro) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Bitopro) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Bitopro) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Bitopro) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Bitopro) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
