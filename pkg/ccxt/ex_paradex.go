...
func (this *Paradex) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("paradex"),
		"name": MkString("paradex"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.paradex.com"),
				"private": MkString("https://api.paradex.com"),
			}),
			"www": MkString("https://www.paradex.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Paradex) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Paradex) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Paradex) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Paradex) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Paradex) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
