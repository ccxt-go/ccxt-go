...
func (this *Bitrue) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("bitrue"),
		"name": MkString("bitrue"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.bitrue.com"),
				"private": MkString("https://api.bitrue.com"),
			}),
			"www": MkString("https://www.bitrue.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Bitrue) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Bitrue) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Bitrue) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Bitrue) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Bitrue) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
