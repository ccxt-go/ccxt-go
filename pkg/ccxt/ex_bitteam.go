...
func (this *Bitteam) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("bitteam"),
		"name": MkString("bitteam"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.bitteam.com"),
				"private": MkString("https://api.bitteam.com"),
			}),
			"www": MkString("https://www.bitteam.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Bitteam) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Bitteam) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Bitteam) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Bitteam) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Bitteam) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
