...
func (this *Modetrade) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("modetrade"),
		"name": MkString("modetrade"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.modetrade.com"),
				"private": MkString("https://api.modetrade.com"),
			}),
			"www": MkString("https://www.modetrade.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Modetrade) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Modetrade) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Modetrade) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Modetrade) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Modetrade) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
