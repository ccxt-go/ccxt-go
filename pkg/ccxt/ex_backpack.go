...
func (this *Backpack) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("backpack"),
		"name": MkString("backpack"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.backpack.com"),
				"private": MkString("https://api.backpack.com"),
			}),
			"www": MkString("https://www.backpack.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Backpack) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Backpack) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Backpack) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Backpack) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Backpack) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
