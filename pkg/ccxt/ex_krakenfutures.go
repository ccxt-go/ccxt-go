...
var _ Exchange = (*Krakenfutures)(nil)
...
func (this *Krakenfutures) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("krakenfutures"),
		"name": MkString("krakenfutures"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.krakenfutures.com"),
				"private": MkString("https://api.krakenfutures.com"),
			}),
			"www": MkString("https://www.krakenfutures.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Krakenfutures) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Krakenfutures) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Krakenfutures) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Krakenfutures) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Krakenfutures) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
