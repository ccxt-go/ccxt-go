...
func (this *Htx) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.htx.com"),
				"private": MkString("https://api.htx.com"),
			}),
			"www": MkString("https://www.htx.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Htx) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Htx) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Htx) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Htx) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Htx) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
