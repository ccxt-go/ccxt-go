...
func (this *Coincatch) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("coincatch"),
		"name": MkString("coincatch"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.coincatch.com"),
				"private": MkString("https://api.coincatch.com"),
			}),
			"www": MkString("https://www.coincatch.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Coincatch) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Coincatch) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Coincatch) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Coincatch) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Coincatch) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
