...
func (this *Hashkey) Describe(goArgs ...*Variant) *Variant {
	return this.DeepExtend(this.BaseDescribe(), MkMap(&VarMap{
		"id":   MkString("hashkey"),
		"name": MkString("hashkey"),
		...
		"urls": MkMap(&VarMap{
			"api": MkMap(&VarMap{
				"public":  MkString("https://api.hashkey.com"),
				"private": MkString("https://api.hashkey.com"),
			}),
			"www": MkString("https://www.hashkey.com"),
		}),
	}))
}// FetchMarkets 获取交易市场列表
func (this *Hashkey) FetchMarkets(goArgs ...*Variant) *Variant {
...
func (this *Hashkey) FetchTicker(goArgs ...*Variant) *Variant {
...
func (this *Hashkey) FetchOrderBook(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchTrades 获取交易历史
func (this *Hashkey) FetchTrades(goArgs ...*Variant) *Variant {
	symbol := GoGetArg(goArgs, 0, MkUndefined())
	_ = symbol
...
// FetchBalance 获取账户余额
func (this *Hashkey) FetchBalance(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
